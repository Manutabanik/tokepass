...
async function loadEventDetails(
  ...
  return {
    ...
    acceptsBankTransfer: eventAcceptsBankTransfer(
      event.accepts_bank_transfer ?? event.accepts_pos_payments,
    ),
