-- P153: persist V2 draft location (city, coords, province, delivery_mode)
-- when unpacking publish_event_v2.
...
comment on function public.publish_event_v2(uuid, jsonb) is
  'Event Creator V2: unpacks draft JSON into events/venues/ticket_tiers, including location geo and delivery_mode.';
