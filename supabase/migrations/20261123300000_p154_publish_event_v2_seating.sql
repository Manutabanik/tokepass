-- P154: unpack seatingMap into venue_map / seated ticket_tiers and
-- materialize seating units. Keeps P153 geo + delivery_mode behavior.
...
comment on function public.publish_event_v2(uuid, jsonb) is
  'Event Creator V2: unpacks draft JSON into events/venues/ticket_tiers, including geo, seating maps and seated SKUs.';
