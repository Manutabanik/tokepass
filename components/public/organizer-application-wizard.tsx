  ...
  if (initialStatus === "pending" || done) {
    return (
      <div className="rounded-3xl border border-emerald-500/25 bg-emerald-500/10 px-6 py-10 text-center">
        <span className="mx-auto grid size-14 place-items-center rounded-2xl bg-emerald-500/15 text-emerald-300 ring-1 ring-emerald-400/30">
          <CheckCircle2 className="size-7" aria-hidden="true" />
        </span>
        <h2 className="mt-5 text-2xl font-black text-white">
          Solicitud enviada
        </h2>
        <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-emerald-100/80">
        ...
        {step === 0 ? (
          <div className="space-y-5">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="inline-flex items-center gap-2 text-zinc-200">
