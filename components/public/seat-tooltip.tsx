...
export function SeatTooltip({
  ...
  return (
    <div
      className="pointer-events-none absolute z-30 rounded-xl border border-white/20 bg-black/90 px-3 py-1.5 text-xs shadow-2xl backdrop-blur-md transition-all"
      style={{ left: x, top: y }}
      role="status"
    >
      ...
      <div className="mt-0.5 font-black text-emerald-400">
