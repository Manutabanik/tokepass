...
export function SuperAdminSidebar({ user }: { user: SuperAdminSidebarUser }) {
  ...
  return (
    <aside
      className={cn(
        "z-30 hidden h-full shrink-0 flex-col justify-between overflow-hidden border-r border-zinc-200 bg-white scrollbar-thin dark:border-zinc-800 dark:bg-zinc-950 md:flex",
        collapsed ? "w-20" : "w-64",
      )}
    >
