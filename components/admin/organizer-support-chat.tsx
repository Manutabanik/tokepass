...
export function OrganizerSupportChat() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-4 bottom-[calc(5.25rem+env(safe-area-inset-bottom))] z-50 flex flex-col items-end gap-3 lg:bottom-6 lg:right-6 lg:left-auto">
      {open ? (
