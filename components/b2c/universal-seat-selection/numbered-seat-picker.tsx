    ...
    <section className="space-y-4">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-500">
          Primero la fila, mesa o bloque; después el asiento.
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <select
          ...
          className={cn(
            "h-12 w-full appearance-none rounded-xl border border-zinc-800 bg-zinc-900 px-3 text-sm text-white",
        ...
        <div className="space-y-3">
          <div className="flex flex-wrap gap-3 text-[11px] text-zinc-500">
            <span className="inline-flex items-center gap-1.5">
              <span className="size-3 rounded-md bg-zinc-200" /> Disponible
            </span>
            <span className="inline-flex items-center gap-1.5">
              <span className="size-3 rounded-md bg-zinc-700" /> Ocupado
            </span>
            <span className="inline-flex items-center gap-1.5">
              <span
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    locked &&
                      "cursor-not-allowed bg-zinc-800 text-zinc-600 line-through opacity-70",
                    !locked &&
                      !selected &&
                      "border border-zinc-600 bg-zinc-100 text-zinc-950 hover:bg-white",
